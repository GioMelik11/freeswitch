...
const upsert_queue_dto_1 = require("./dto/upsert-queue.dto");
...
], QueuesController.prototype, "getConfig", null);
__decorate([
    (0, common_2.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [upsert_queue_dto_1.UpsertQueueDto]),
    __metadata("design:returntype", void 0)
], QueuesController.prototype, "upsert", null);
__decorate([
    (0, common_1.Delete)(':name'),
    __param(0, (0, common_1.Param)('name')),
    __param(1, (0, common_1.Query)('domain')),
    __param(2, (0, common_1.Query)('etag')),
    __metadata("design:type", Function),
...
exports.QueuesController = QueuesController = __decorate([
    ...
    (0, common_1.Controller)('pbx/queues'),
